...
class FerramentasFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view : View = inflater.inflate(R.layout.fragment_ferramentas, container, false)

        produtosRecuperados =  FirebaseDatabase.getInstance().reference.child("produtos")


        recyclerViewProdutos = view.findViewById(R.id.recycler_produtos_ferramentas)
        ...
        produtosRecuperados.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for (d in dataSnapshot.children){
                    ...
                    if(u!!.categoria.equals("Ferramentas")){
                        produtos.add(u!!)
                    }
                }
