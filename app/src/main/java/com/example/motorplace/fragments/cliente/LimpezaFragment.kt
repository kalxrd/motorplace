...
class LimpezaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view : View = inflater.inflate(R.layout.fragment_limpeza, container, false)

        produtosRecuperados =  FirebaseDatabase.getInstance().reference.child("produtos")


        recyclerViewProdutos = view.findViewById(R.id.recycler_produtos_limpeza)
